...
MASCP.UbiquitinReader=MASCP.buildService(function(data){this._raw_data=data?data.data:null;return this;});MASCP.UbiquitinReader.SERVICE_URL='?';MASCP.UbiquitinReader.prototype.requestData=function()
...
{var content=null;if(!this._raw_data||!this._raw_data.peptides){return[];}
return this._raw_data.peptides;};MASCP.UbiquitinReader.Result.prototype._cleanSequence=function(sequence)
