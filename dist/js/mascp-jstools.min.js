...
return results;};MASCP.ClustalRunner.Result.prototype.getAlignment=function(){console.log(this._raw_data);this._text_data=this._raw_data;var re=/ {16}(.*)/g;var result="";var match=re.exec(this._raw_data);while(match!==null){result+=match[1];match=re.exec(this._raw_data);}
...
var no_touch_center=false;if(self.zoomCenter=='center'){no_touch_center=true;self.zoomCenter={'x':self._RS*(self.leftVisibleResidue()+0.5*(self.rightVisibleResidue()-self.leftVisibleResidue()))};}
