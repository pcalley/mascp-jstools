...
return ret;};var findUncoveredRegions=function(arr){var coveredIndeces=[];var results=[];var seqLength=sequence.length;var toPercent=function(indeces){var left=(indeces[0]/seqLength);var right=(indeces[1]/seqLength);return[left,right];};for(var i=0;i<arr.length;i++){var hitIndex=sequence.indexOf(arr[i]);if(hitIndex>=0){coveredIndeces.push([hitIndex,(hitIndex+arr[i].length)]);}}
