...
MASCP.registerLayer('processing',{'fullname':'N-Terminal (mod)','color':'#ffEEEE','css':css_block});sequenceRenderer.getAA(1).addBoxOverlay('processing',(pos+pep.length+0.5),1);sequenceRenderer.getAA(pos+1+pep.length).addAnnotation('processing',1,{'border':'rgb(150,0,0)','content':'M','angle':0});jQuery(sequenceRenderer).trigger('resultsRendered',[reader]);});return this;};MASCP.ProcessingReader.Result.prototype.render=function()
{};if(typeof MASCP=='undefined'||typeof MASCP.Service=='undefined'){throw"MASCP.Service is not defined, required class";}
