...
{};if(typeof MASCP=='undefined'||typeof MASCP.Service=='undefined'){throw"MASCP.Service is not defined, required class";}
MASCP.GoogledataReader=MASCP.buildService(function(data){return this;});(function(){var attach_google_scripts=function(){var head=document.getElementsByTagName('head')[0];var script=document.createElement('script');script.type='text/javascript';script.src="http://www.google.com/jsapi";head.appendChild(script);return;};if(typeof google=='undefined'){attach_google_scripts();}
...
service.setHeaders(headers_block);service.getFeed(feedUrl,function(data){callback.call(null,null,parsedata(data));},callback,google.gdata.Feed);}else{callback.call(null,null,dat);}});};MASCP.GoogledataReader.prototype.getDocumentList=documents;MASCP.GoogledataReader.prototype.getDocument=get_document;MASCP.GoogledataReader.prototype.createReader=function(doc,map){var self=this;var reader=new MASCP.UserdataReader();reader.datasetname=doc;(function(){var a_temp_reader=new MASCP.UserdataReader();a_temp_reader.datasetname=doc;MASCP.Service.CacheService(a_temp_reader);MASCP.Service.CachedAgis(a_temp_reader,function(accs){if(accs.length<1){get_data(null);return;}
...
return reader;};})();MASCP.GoogledataReader.prototype.setupSequenceRenderer=function(renderer){};if(typeof MASCP=='undefined'||typeof MASCP.Service=='undefined'){throw"MASCP.Service is not defined, required class";}
