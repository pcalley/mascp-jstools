...
self.zoomCenter=null;self._container_canvas.removeAttribute('viewBox');self.withoutRefresh(function(){self.zoom=zoomFactor;});self.grow_container=true;self.refresh();self.grow_container=false;};window.matchMedia('print').addListener(self._media_func);};clazz.prototype.refresh=function(animated){if(!this._canvas){return;}
