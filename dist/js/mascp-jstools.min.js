...
var thisRating=9-(maxRating+(isPredicted==true?5:0));var colorStr=''+thisRating+thisRating;if(locate[0]>=0.005){gradient.appendChild(this.makeEl('stop',{'offset':(locate[0]-0.005),'style':'stop-color:#ccc;stop-opacity:1'}));}
