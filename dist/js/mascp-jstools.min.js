...
jQuery(canvas).unbind('panend',arguments.callee);});},false);canvas.addEventListener('zoomChange',function(){if(canvas.zoom>3.6){renderer._axis_height=14;amino_acids.attr({'y':12*RS,'visibility':'visible'});amino_acids_shown=true;update_sequence();}else{renderer._axis_height=30;amino_acids.attr({'y':-1000,'visibility':'hidden'});amino_acids_shown=false;}
