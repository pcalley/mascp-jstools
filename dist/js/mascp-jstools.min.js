...
renderer.select=function(){var vals=Array.prototype.slice.call(arguments);var from=vals[0];var to=vals[1];this.moveHighlight.apply(this,vals);};var a_text;if(has_textLength&&('lengthAdjust'in document.createElementNS(svgns,'text'))&&('textLength'in document.createElementNS(svgns,'text'))){if(this.sequence.length<=1500){a_text=canvas.text(0,12,document.createTextNode(this.sequence));a_text.setAttribute('textLength',RS*this.sequence.length);}else{a_text=canvas.text(0,12,document.createTextNode(this.sequence.substr(0,1500)));console.log(this.sequence.substr(0,1500).length);a_text.setAttribute('textLength',RS*1500);}
...
var update_sequence=function(){var start=parseInt(renderer.leftVisibleResidue());start-=50;if(start<0){start=0;}
