...
var RS=this._RS;var rows=parseInt(in_text.length/this.sequence.length);var texts=[];if(rows>1){var grps=in_text.match(new RegExp(".{"+rows+"}","g"));for(var i=0;i<grps.length;i++){var tot_length=grps[i].length-1;while(tot_length>=0){if(!texts[tot_length]){texts[tot_length]="";}
